...
<body style="background-color: #d1e0e0;">
	...
	<?php
		...
		if (isset($_POST['change_uname'])) 
		{
			...
			{
				$query = "UPDATE patient SET username='$uname' WHERE id='$patient'";
				$res = mysqli_query($connect,$query);
				if ($res) 
				{
					$_SESSION['user_patient'] = $uname;
				}
			}
		}
							...
							<div class="col-md-6" style="margin-top: 50px;">
								...
								<?php
									...
									if (isset($_POST['upload'])) 
									{
										...
										{
											$query = "UPDATE patient SET profile='$img' WHERE id='$patient'";
											$res = mysqli_query($connect,$query);
											if($res)
											{
												move_uploaded_file($_FILES['img']['tmp_name'], "../patient/img/$img");
											}
										}
									}
									$query = "SELECT * FROM patient WHERE id='$patient'";
							...
							<div class="col-md-6" style="margin-top: 50px;">
								...
								<?php
									...
									if ($_POST['change_pass']) 
									{
										...
										$ol = "SELECT * FROM patient WHERE id='$patient'";
										...
										{
											$query = "UPDATE patient SET password='$new' WHERE id='$patient'";
