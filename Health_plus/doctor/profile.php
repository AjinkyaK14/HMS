...
<body style="background-color: #d1e0e0;">
	...
	<?php
		...
		if (isset($_POST['change_uname'])) 
		{
			...
			{
				$query = "UPDATE doctors SET username='$uname' WHERE id='$doc'";
							...
							<div class="col-md-6" style="margin-top: 50px;">
								...
								<?php
									...
									if (isset($_POST['upload'])) 
									{
										...
										{
											$query = "UPDATE doctors SET profile='$img' WHERE id='$doc'";
											$res = mysqli_query($connect,$query);
									...
									$query = "SELECT * FROM doctors WHERE id='$doc'";
							...
							<div class="col-md-6" style="margin-top: 50px;">
								...
								<?php
									...
									if ($_POST['change_pass']) 
									{
										...
										$ol = "SELECT * FROM doctors WHERE id='$doc'";
										...
										{
											$query = "UPDATE doctors SET password='$new' WHERE id='$doc'";
